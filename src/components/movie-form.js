...
class MovieForm extends Component {
    ...
    render() {
        ...
        const isDisabled = this.state.editedMovie.title.length === 0 || 
                            this.state.editedMovie.title.description === 0;

        return (
            <React.Fragment>
                <span>Title</span><br />
                <input type="text" name="title" defaultValue={this.props.movie.title}
                    onChange={this.inputChanged} /><br />

                <span>Description</span><br />
                <textarea type="text" name="description" defaultValue={this.props.movie.description}
                    onChange={this.inputChanged} /><br />
